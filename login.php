...
<div id="login">
	...
	<div class="container">
		...
		<div class="wrapper">
			...
			<h1 class="glyphicons lock">Museum <img src="<?php echo $base; ?>images/icon.png" width="50"> Geologi</h1>
			...
			<div class="widget widget-heading-simple widget-body-gray">
				...
				<div class="widget-body">
					...
					<!-- Form -->
					<form method="post" action="<?php echo $base; ?>ceklogin">
				...
				<div class="widget-footer">
					<p class="glyphicons notes"><i></i> <a href="<?php echo $base; ?>kunjungan" target="_blank">Kunjungan</a></p>
				</div>
			</div>
			<!-- // Box END -->
